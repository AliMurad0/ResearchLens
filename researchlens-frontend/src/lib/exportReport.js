...
// jsPDF's built-in fonts are WinAnsi-only. Any character outside that set
// forces the whole line into UTF-16, which renders as garbled, overlapping
// text. Normalize before drawing.
